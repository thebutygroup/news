...
if not TEST_DB:
    collect_ignore = ["test_pipeline.py", "test_api.py", "test_sources.py", "test_tagging.py", "test_podcast.py"]  # database tests need TEST_DATABASE_URL
...
def pytest_collection_modifyitems(items):
    ...
    order = {"test_normalize.py": 0, "test_llm.py": 0, "test_pipeline.py": 1, "test_api.py": 2, "test_sources.py": 3, "test_tagging.py": 4, "test_podcast.py": 5}
